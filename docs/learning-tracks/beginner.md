...
Welcome to Power BI! This track will help you build a solid foundation in business intelligence and reporting.
...
| --- | --- | --- | --- | --- |
| [Prepare and visualize data with Microsoft Power BI](https://learn.microsoft.com/en-us/training/paths/prepare-visualize-data-power-bi/) | <span class="type-label official">Official</span> | <span class="type-label">Data Prep</span> <span class="type-label">Visuals</span> |  | Importing, cleaning, transforming data; visuals fundamentals |
| [Power BI Beginner's Tutorial (2025)](https://www.youtube.com/watch?v=MikekdopYhE) | <span class="type-label video">Video</span> | <span class="type-label">End-to-End</span> |  | End-to-end walkthrough |
...
Ready to level up? Move on to the [Intermediate Track](intermediate.md) to master advanced DAX and data modeling!
