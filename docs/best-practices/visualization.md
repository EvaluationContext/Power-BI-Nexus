...
- Use [themes](https://learn.microsoft.com/en-us/power-bi/create-reports/desktop-report-themes) for consistency between reports
...
- Sufficient color contrast ([WCAG AA](https://www.w3.org/WAI/WCAG2AA-Conformance))
